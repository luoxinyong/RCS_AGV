#ifndef SLAM_AD_MODELS_KALMAN_FILTER_KALMAN_FILTER_HPP_
#define SLAM_AD_MODELS_KALMAN_FILTER_KALMAN_FILTER_HPP_
...
public:
   ...
   */
  virtual void Init(const Eigen::Matrix4d& init_pose, const Eigen::Vector3d &vel, const IMUData &imu_data) = 0;
...
protected:
  ...
  struct {
    ...
    std::vector<Eigen::MatrixXd, Eigen::aligned_allocator<Eigen::MatrixXd>> Q_;
    std::vector<Eigen::VectorXd, Eigen::aligned_allocator<Eigen::VectorXd>> Y_;
  } observability;
