#ifndef SLAM_AD_MODELS_KALMAN_FILTER_ERROR_STATE_KALMAN_FILTER_HPP_
#define SLAM_AD_MODELS_KALMAN_FILTER_ERROR_STATE_KALMAN_FILTER_HPP_
...
public:
   ...
   */
  void Init(const Eigen::Matrix4d& init_pose, const Eigen::Vector3d &vel, const IMUData &imu_data);
...
private:
 ...
 /** lxy 9.12修改
   ...
   * @return void
   */
  void CorrectErrorEstimationPoseVel(const Eigen::Matrix4d &T_nb, const Eigen::Vector3d &v_b,
                                  Eigen::VectorXd &Y, Eigen::MatrixXd &G,
                                  Eigen::MatrixXd &K);
  /**
