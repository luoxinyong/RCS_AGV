...
int main(int argc, char** argv) {
  std::vector<Eigen::Vector4f> target_points = read_ply("/home/bnxy/dataset/reloc_03pcd/2.ply");
  std::vector<Eigen::Vector4f> source_points = read_ply("/home/bnxy/dataset/reloc_03pcd/1756175929.ply");
