...
const HelpPanel = () => {
  ...
  return (
    <>
      ...
      <button
        title="快捷键帮助"
        className="absolute bottom-6 right-6 w-8 h-8 bg-gray-800 bg-opacity-70 text-white rounded-full flex items-center justify-center hover:bg-opacity-90 shadow-lg"
      ...
      {/* 帮助面板 */}
      {isOpen && (
        <div className="absolute bottom-16 right-6 rounded-lg w-64 border border-gray-200">
