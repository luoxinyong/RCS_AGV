...
bool UdpClient::ConstructAndSendMsg(const unsigned int data_len, const unsigned char *data)
{
    ...
    header_send_data_.sender_ip_1 = 192;
    header_send_data_.sender_ip_2 = 168;
    header_send_data_.sender_ip_3 = 2;
    header_send_data_.sender_ip_4 = 110;
    ...
    //ROS_INFO("nav_step_9: send_to_plc: mid = %x, len = %d", header_send_data_.mid, msg_len);
//    for (int i = 0; i < msg_len; i++) {
//        ROS_INFO("[%d]%x #n", i + 1, msg_send_[i]);
//    }
